...
function Tab({id, text, setCheckedItems, checkedItemId}) {
	...
	return (
		<label
			htmlFor={id}
			className="font-specialelite text-lg md:text-xl transition-colors text-light-text-disable has-checked:text-light-text dark:text-dark-text-disable has-checked:dark:text-dark-text cursor-pointer"
			draggable={false}>
			<input
				type="radio"
				name={"grid-tabs"}
